...
use Pear\Http\Request2\Adapters\Curl;
 ...
 */
class CurlTest extends CommonNetworkTest
{
   /**
    ...
    */
    ...
    public function testBug17450()
    {
        ...
        try {
            ...
            $this->assertEquals(Request2Exception::MISCONFIGURATION, $e->getCode());
        }
    }
...
//            $this::expectException(Request2Exception::class);
//        }
