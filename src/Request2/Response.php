...
class Response
{
     ...
     */
    public static function getDefaultReasonPhrase(int $code = null)
    {
        if (null === $code) {
            return self::$phrases;
        } else {
     ...
     * @param string|null $effectiveUrl Effective URL of the response
     *
     * @throws MessageException () if status line is invalid according to spec
     */
    public function __construct(string $statusLine, bool $bodyEncoded = true, string $effectiveUrl = null)
    {
     ...
     *
     * @return   string
     * @throws   Request2Exception if body cannot be decoded
     */
     ...
     * sanity check fails, MessageException() is thrown.
     *
