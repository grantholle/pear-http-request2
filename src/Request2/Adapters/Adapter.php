...
/**
 * Base class for Request2 adapters
 *
 * PHP version 5
 *
 * LICENSE
 ...
 * Base class for Request2 adapters
 *
 * Request2 class itself only defines methods for aggregating the request
...
abstract class Adapter
{
    ...
    /**
     * Request body
     * @var  string|resource|MultipartBody
     * @see  Request2::getBody()
     */
     ...
     * @throws   Exception
     */
    abstract public function sendRequest(Request2 $request);
