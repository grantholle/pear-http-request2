...
namespace Pear\Http\Request2\Observers;
 ...
 *
 * $request  = new Request2('http://www.example.com');
 * $observer = new Request2_Observer_Log();
 ...
 * $observer = new Request2_Observer_Log(Log::factory('console'));
 *
...
class LogObserver implements \SplObserver
{
     ...
     * Constructor.
     *
     * @param mixed $target Can be a file path (default: php://output), a resource, or an instance of the PEAR Log class.
    ...
    public function __construct($target = 'php://output', array $events = [])
    {
        ...
        if (is_resource($target) || $target instanceof Log) {
            ...
            throw new Request2Exception("Unable to open '{$target}'");
        }
    }
     ...
     *
     * @param \SplSubject $subject The Request2 instance
     * @return void
     */
