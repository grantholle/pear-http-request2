...
namespace Pear\Http\Request2\Exceptions;
 ...
 */
class Request2Exception extends Exception
{
     ...
     * @param int|null $code package error code, one of class constants
     * @param int|null $nativeCode error code from underlying PHP extension
     * @throws Exception
     */
    public function __construct(string $message = null, int $code = null, int $nativeCode = null)
    {
